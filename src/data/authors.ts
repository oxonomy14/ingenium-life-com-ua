...
export const authors = {
  'pavel-dementiev': {
    ...
    description:
      'Засновник проєкту InGenium, астролог, таролог, психоаналітик Школи Юнга, письменник, автор курсів і власних методик, тренер особистісного зростання. «Я роблю астрологію живою, практичною та точною».',
